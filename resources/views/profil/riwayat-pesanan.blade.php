...
<body class="antialiased">
                ...
                <div class="w-full items-start">
                    <div class="w-full">
                        <div class="w-full justify-start items-start flex-col flex gap-9">
                            ...
                            <div
                                class="w-full relative bg-gray-100 shadow-gray-300 shadow-md rounded-xl flex-col inline-flex p-8 text-justify">
                            ...
                            <div
                                class="w-full relative bg-gray-100 shadow-gray-300 shadow-md rounded-xl flex-col inline-flex py-8 ">
                                <div class="w-full relative bg-gray-100 flex-col inline-flex gap-4">

                                    <div
                                        class="w-full relative bg-orange-500 flex-row flex justify-center items-center px-10 py-2 font-semibold text-l text-gray-50 font-['Montserrat']">
                                    ...
                                    <div
                                        ...
                                        <div class="w-full relative text-l text-gray-800">
                                    ...
                                    <div class="w-full relative justify-end items-end flex px-10">
                                        <div class="justify-center items-center flex flex-col">
                                            <div class="w-full relative justify-center flex text-l text-gray-800">
                                                Total Harga Keseluruhan
                                            </div>
                                            <div
                                                class="w-full relative justify-center flex text-3xl font-bold text-gray-800">
                                                Rp 140.0000
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="w-full relative flex-row flex">
                                        <div class="w-full relative justify-start items-center flex px-10">
                                            <button
                                                class="px-5 py-3 gap-4 bg-gray-50 rounded-[10px] border-2 border-blue-500 inline-flex hover:opacity-75">
 ...
 {{-- <div
 class="w-full h-fit flex-col flex relative bg-gray-100 shadow-gray-300 shadow-md p-5 gap-6 rounded-2xl ">
 <div class="w-full h-fit justify-between items-center flex relative rounded-tr-2xl rounded-tl-2xl">
     ...
     <i class="ph-bold ph-x text-3xl text-gray-500"></i>
 </div>

 <div class="w-full rounded-full border-2 border-gray-200  items-start inline-flex">
 </div>

 <div class="w-full flex flex-col relative ">
     <div class="w-full flex flex-row relative justify-between">
         <div class="text-xl text-gray-800 font-bold font-['Montserrat'] ">
             No.Invoice
         </div>
