<!-- TOP HEADER -->
<div class="w-full h-fit bg-gray-200  px-20 py-4 justify-center flex items-center  flex-row">

    <div class="w-full flex flex-row gap-10">

        <div class="justify-start items-center gap-2.5 flex w-fit h-fit">
            <i class="ph-fill text-gray-500 ph-phone text-2xl"></i>
            <div class="text-gray-500 text-base font-normal font-['Montserrat']">6281317554872</div>
        </div>

        <div class="justify-start items-center gap-2.5 flex w-fit h-fit">
            <i class="ph-fill text-gray-500 ph-house text-2xl"></i>
            <div class="text-gray-500 text-base font-normal font-['Montserrat']">Jl. Raya Sukahati,
                Kabupaten Bogor, Jawa Barat 16913</div>
        </div>

        <div class="justify-start items-center gap-2.5 flex w-fit h-fit">
            <i class="ph-bold text-gray-500 ph-clock text-2xl"></i>
            <div class="text-center text-gray-500 text-base font-normal font-['Montserrat']">Senin - Sabtu |
                08.00 - 18.00 WIB</div>
        </div>
    </div>
