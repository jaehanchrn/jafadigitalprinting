...
<body class="antialiased">
    <div class="w-full h-fit relative bg-white">
        ...
        <div class="w-full h-fit flex-col justify-start inline-flex py-20 px-16 gap-4">
            ...
            <div class="w-full justify-center items-center flex relative bg-gray-100 shadow-md shadow-gray-300 border-gray-200 border-2 rounded-[32px]">
                <div class="w-full flex-col inline-flex relative justify-center items-center px-20 py-8 gap-12">
                    <div
                        class="w-full flex justify-center items-center text-gray-50  text-3xl font-bold font-['Montserrat'] bg-blue-500 py-6">
                        CARA ORDER
                    ...
                    <div
                        ...
                        <div class="text-gray-800 text-lg font-normal font-['Montserrat']">1. Silahkan pilih menu <a
                                class="font-bold"> ‘Produk dan Jasa’ </a> kolom tabbing diatas.
                        </div>
                        <div class="text-gray-800 text-lg font-normal font-['Montserrat']">2. Pilih Kategori yang
                            anda inginkan.
                        </div>
                        <div class="text-gray-800 text-lg font-normal font-['Montserrat']">3. Jika anda memilih <a
                        ...
                        <div class="text-gray-800 text-lg font-normal font-['Montserrat']">4. Jika anda memilih <a
                        ...
                        <div class="text-gray-800 text-lg font-normal font-['Montserrat']">5. Jika anda memilih <a
                                class="font-bold"> ‘Jasa
                                Cetak’, </a> maka akan muncul halaman Jasa Cetak Banner.
                        </div>
                        <div class="text-gray-800 text-lg font-normal font-['Montserrat']">6. Pilih <a
                                class="font-bold"> ‘Kategori Jasa
                                Cetak’ </a> dengan jasa yang anda inginkan.
                        </div>
                        <div class="text-gray-800 text-lg font-normal font-['Montserrat']">7. Silahkan isi data pada
                            kolom yang tersedia sesuai dengan kebutuhan anda. Jangan lupa untuk mengecek kolom deskripsi
                            terlebih dahulu.
                        </div>
                        <div class="text-gray-800 text-lg font-normal font-['Montserrat']">8. Jika sudah, silahkan
                            klik tombol <a class="font-bold"> ‘Tambah ke Keranjang’. </a>
                        </div>
                        <div class="text-gray-800 text-lg font-normal font-['Montserrat']">9. Lakukan hal yang sama
                            jika anda ingin melakukan pesanan yang lain.
                        </div>
                        <div class="text-gray-800 text-lg font-normal font-['Montserrat']">10. Selanjutnya, klik ikon
                            keranjang yang terletak di paling atas.
                        </div>
                        <div class="text-gray-800 text-lg font-normal font-['Montserrat']">11. Kemudian, klik tombol
                            <a class="font-bold"> ‘Selanjutnya’ </a> lanjut ke proses data penerima.
                        </div>
                        <div class="text-gray-800 text-lg font-normal font-['Montserrat']">12. Masukkan data penerima
                            dan alamat yang sesuai untuk mengirim pesanan anda, jika sudah klik tombol <a
                                class="font-bold"> ‘Selanjutnya’. </a>
                        </div>
                        <div class="text-gray-800 text-lg font-normal font-['Montserrat']">13. Kemudian, pilih opsi
                            pengiriman, dan klik <a class="font-bold"> ‘Selanjutnya’. </a>
                        </div>
                        <div class="text-gray-800 text-lg font-normal font-['Montserrat']">14. Pada tahap ini, anda
                        ...
                        <div class="text-gray-800 text-lg font-normal font-['Montserrat']">15. Klik tombol
                            <a class="font-bold"> ‘Konfirmasi’. </a>
                        </div>
                        <div class="text-gray-800 text-lg font-normal font-['Montserrat']">16. Selanjutnya data sudah
                        ...
                        <div class="text-gray-800 text-lg font-normal font-['Montserrat']">17. Anda dapat melihat
                    ...
                    <div
                        ...
                        <div class="text-gray-800 text-lg font-normal font-['Montserrat']">Pada setiap pesanan jasa
                        ...
                        <div class="text-gray-800 text-3xl font-bold font-['Montserrat']">PENGATURAN WARNA PADA FILE
                        </div>
                        <br>
                        <div class="text-gray-800 text-lg font-normal font-['Montserrat']">Dalam pembuatan desain,
                        ...
                        <div class="text-gray-800 text-3xl font-bold font-['Montserrat']">RESOLUSI GAMBAR
                        </div>
                        <br>
                        <div class="text-gray-800 text-lg font-normal font-['Montserrat']">Untuk resolusi gambar,
                            kami sangat menyarankan menggunakan resolusi <a class="font-bold"> 300 dpi. </a>
                        </div>
                        <br>

                        <div class="text-gray-800 text-3xl font-bold font-['Montserrat']">BATAS KERTAS
                        </div>
                        <br>
                        <div class="text-gray-800 text-lg font-normal font-['Montserrat']">Untuk mendapatkan hasil
                        ...
                        <div class="text-gray-800 text-3xl font-bold font-['Montserrat']">PENGATURAN FILE YANG
                            DIUNGGAH
                        </div>
                        <br>
                        <div class="text-gray-800 text-lg font-normal font-['Montserrat']">Anda dapat mengirimkan
