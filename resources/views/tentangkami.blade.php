        ...
        <div class="w-full h-fit flex-col justify-start inline-flex py-20 px-16 gap-4">
            ...
            <div
                ...
                <div class="w-full flex-col flex relative justify-center items-center py-12">
                    <div
                        class="w-full flex justify-center items-center text-gray-50  text-5xl font-bold font-['Montserrat'] bg-blue-500 py-6 mt-6">
                    ...
                    <div
                        class="w-full flex-col flex relative justify-start items-start text-gray-800  text-3xl font-bold font-['Montserrat'] px-20 py-12">

                        <div class="text-gray-800 text-2xl font-normal font-['Montserrat']"> <a class="font-bold">
