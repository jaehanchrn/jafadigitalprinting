        ...
        <div class="w-full flex-col justify-center items-center flex py-16">
            <div class="w-[1000px] h-fit flex-col flex items-center relative  gap-20">
                <div class="w-full flex-col flex justify-center items-center">
                    <div class="text-center text-gray-800 text-[64px] font-normal font-['Montserrat']">Jasa Cetak
                    </div>
                    <div class=" text-center text-gray-500 text-xl font-normal font-['Montserrat']">Ingin cetak dalam
            ...
            <div class="w-full justify-start px-12 relative">
                <div class="w-full flex-col flex justify-center items-start  relative ">
                    <div class="w-[410px] h-[95px] items-center flex bg-blue-500 rounded-tl-2xl rounded-tr-2xl">
                        <div class="pl-12 relative text-gray-50 text-[40px] font-normal font-['Montserrat']">
                            Photo</div>
                    </div>
                </div>
            </div>
                ...
                <div class="w-full h-fit flex flex-col justify-start">
                    ...
                    <div class="w-full flex-col justify-center items-start gap-8 pt-12 inline-flex">
                        ...
                        {{-- <div class="w-full  justify-start items-start flex">
                            <div class="w-[600px] rounded-full border-2 border-gray-400  items-start inline-flex">
                            </div>
                        </div> --}}

                        <div class="w-[600px] relative">
                            <div
                                class="relative bg-gray-100 shadow-md shadow-gray-300 border-2 border-gray-300 rounded-xl flex-col inline-flex p-8 w-full text-justify">

                                <div class=" text-justify text-red-500 text-3xl font-bold font-['Montserrat']">
                                    PERLU DIPERHATIKAN!!
                                </div>
                                <br>
                                <div class="text-gray-800 text-lg font-normal font-['Montserrat']">Warna yang
                                ...
                                <div class="text-gray-800 text-lg font-normal font-['Montserrat']">Kami menyediakan
                                    layanan jasa cetak photo dengan berbagai ukuran dan berbagai jenis kertas. Silahkan
                                    order sesuai kebutuhan anda!
                                </div>

                                <br>
                                <div class="text-gray-800 text-lg font-normal font-['Montserrat']">Jenis Bahan Kertas
                                    yang tersedia :<br>
                                ...
                                <br>
                                <div class="text-gray-800 text-lg font-normal font-['Montserrat']">!!!!! Hanya
                ...
                <div class="w-full items-start">
                    <div class="w-[600px]">
                        <form action="{{ route('orders.store') }}" method="POST" enctype="multipart/form-data"
                            ...
                            @csrf
                            <div
                                class=" justify-start items-start text-gray-800 text-5xl font-normal font-['Montserrat']  ">
                                Cetak Photo Berbagai Ukuran
                            </div>

                            <div class="w-full flex-col justify-start items-start flex">
                                <div
                                    class="w-[600px] rounded-full border-2 border-gray-300  items-start inline-flex">
                                </div>
                            </div>
                            ...
                            <div class="w-full flex flex-col justify-start items-start gap-8">
                                ...
                                <div class="w-[600px] flex flex-col gap-2">
                                    <div class="text-gray-800 text-2xl font-bold font-['Montserrat']">
                                        UKURAN</div>
                                    {{-- <div class="text-gray-500 text-l font-normal font-['Montserrat']">
                                   *dalam meter</div> --}}
                                    <div class=" dropdown inline-block relative ">
                                        <select name="size"
                                            class="w-full cursor-pointer p-5 bg-gray-50 text-gray-600 rounded-lg border border-gray-800 text-xl font-normal font-['Montserrat'] focus:group/button-active  justify-between items-start inline-flex ">
                                            <option
                                                class="rounded-t-lg bg-gray-200 text-gray-800 hover:text-blue-300 py-2 px-4 text-xl font-normal font-['Montserrat'] block whitespace-no-wrap"
                                ...
                                <div class="w-[600px] flex flex-col gap-2">
                                    <div class="text-gray-800 text-2xl font-normal font-['Montserrat']">
                                        Jenis Kertas</div>
                                    {{-- <div class="text-gray-500 text-l font-normal font-['Montserrat']">
                                   *dalam meter</div> --}}
                                    <div class=" dropdown inline-block relative ">
                                ...
                                <div class="w-[600px]  flex flex-col gap-2">
                                    <div class="text-gray-800 text-2xl font-normal font-['Montserrat']">
                                        Jumlah</div>
                                    <div
                                        class="p-5 border border-gray-800 rounded-lg bg-gray-50 text-xl font-normal font-['Montserrat']">
                                        <div class="flex justify-between items-center gap-x-1.5">
                                            <button type="button"
                                                class="size-6 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-md border border-gray-200 bg-blue-500 hover:bg-blue-300"
                                                id="decrementButton">
                                                <svg class="ph-bold ph-minus text-3xl text-gray-50" width="24"
                                            ...
                                            <input type="number" name="quantity" id="quantity" min="1"
                                                value="1"
                                                class="p-0 w-fit bg-transparent border-0 text-gray-600 text-center focus:ring-0"
                                ...
                                <div class="w-[600px]  flex flex-col gap-2">
                                    ...
                                    <div class="flex-col justify-between items-start inline-flex">
                                        <input type="file" name="file" id="file"
                                            class="block w-full p-3  text-gray-600 border border-gray-500 rounded-lg cursor-pointer text-xl font-normal font-['Montserrat'] "
                                   ...
                                   *dalam meter</div> --}}
                                    <div class="flex-col justify-between items-start inline-flex">
                                        <textarea name="notes" id="notes" type="tulis-catatan" id="helper-text"
                                            ...
                                            class="bg-gray-50 border border-gray-500 text-gray-600 rounded-lg 
                            ...
                            <div class="w-full h-fit justify-between bg-orange-500 flex flex-row py-4 px-12">
                                <div
                                    class="w-full  items-center flex  text-gray-50 text-2xl font-bold font-['Montserrat']">
                                    Total Harga</div>
                               <input type="number" name="total_price_product" id="total_price_product"
                                    class="w-full bg-orange-500 rounded text-gray-50 text-2xl font-bold font-['Montserrat']" readonly>
                                </input>
                            </div>
