    ...
    public function run(): void
    {
        ...
        DB::table('products')->insert([
            [
                ...
                'price' => 22000,
                'image' => url('pictures/pulpen-standard-hitam.jpg'),
            ],
            [
                'name' => 'Pulpen Standard AE7 Biru (12 pcs)',
                // 'description' => 'Durable and strong transparent tape.',
                'price' => 22000,
                'image' => url('pictures/pulpen-standard-biru.jpg',)
            ],
            [
                'name' => 'Pulpen Standard AE7 Merah (12 pcs)',
                // 'description' => 'Durable and strong transparent tape.',
                'price' => 22000,
                'image' => url('pictures/pulpen-standard-merah.jpg',)
            ],
            ...
            [
                ...
                // 'description' => 'Durable and strong transparent tape.',
                'price' => 54000,
                'image' => url('pictures/pulpen-kenko-k1.jpg',)
            ],
            [
                'name' => 'Buku Sinar Dunia 58halaman (10 pcs)',
                // 'description' => 'Durable and strong transparent tape.',
                'price' => 40000,
                'image' => url('pictures/buku-sidu-58.jpg',)
            ],
            [
                'name' => 'Buku Sinar Dunia 38halaman (10 pcs)',
                // 'description' => 'Durable and strong transparent tape.',
                'price' => 35000,
                'image' => url('pictures/buku-sidu-38.jpg',)
            ],
            ...
            [
                ...
                // 'description' => 'Durable and strong transparent tape.',
                'price' => 90000,
                'image' => url('pictures/buku-folio.jpg',)
            ],
            [
                'name' => 'Tipex Kertas Joyko (10 pcs)',
                // 'description' => 'Durable and strong transparent tape.',
                'price' => 70000,
                'image' => url('pictures/tipex-kertas-joyko.jpg',)
            ],
            [
                'name' => 'Kertas A4 70gsm (500pcs)',
                // 'description' => 'Durable and strong transparent tape.',
                'price' => 53000,
                'image' => url('pictures/kertas-a4-70gsm.jpg',)
            ],
            ...
            [
                ...
                // 'description' => 'Durable and strong transparent tape.',
                'price' => 57000,
                'image' => url('pictures/kertas-f4-70gsm.jpg',)
            ],
            [
                'name' => 'Photo Paper Glossy 120gsm (20pcs)',
                // 'description' => 'Durable and strong transparent tape.',
                'price' => 35000,
                'image' => url('pictures/kertas-photo.jpg',)
            ],
            [
                'name' => 'Lakban Bening Daimaru 2 Inch (6 pcs)',
                // 'description' => 'Durable and strong transparent tape.',
                'price' => 66000,
                'image' => url('pictures/lakban-bening-2inch.jpg',)
            ],
            ...
            [
                ...
                // 'description' => 'Durable and strong transparent tape.',
                'price' => 54000,
                'image' => url('pictures/lakban-bening-1inch.jpg',)
            ],
            [
                'name' => 'Map Kertas Biola (25 pcs) warna merah',
                // 'description' => 'Durable and strong transparent tape.',
                'price' => 45000,
                'image' => url('pictures/map-biola.jpg',)
            ],
            [
            ...
            [
                ...
                // 'description' => 'Durable and strong transparent tape.',
                'price' => 48000,
                'image' => url('pictures/kwitansi-besar.jpg',)
            ],
            [
                'name' => 'Kwitansi Paperline 28x9cm (10 pcs)',
                // 'description' => 'Durable and strong transparent tape.',
                'price' => 42000,
                'image' => url('pictures/kwitansi-kecil.jpg',)
            ],
            ...
            [
                ...
                // 'description' => 'Durable and strong transparent tape.',
                'price' => 20000,
                'image' => url('pictures/amplop-putih-besar.jpg',)
            ],
            [
                'name' => 'Amplop Putih Paperline 11,2x9,5cm',
                // 'description' => 'Durable and strong transparent tape.',
                'price' => 18000,
                'image' => url('pictures/amplop-putih-kecil.jpg',)
            ],
            [
                'name' => 'Crayon Titi Kecil 12 Warna',
                // 'description' => 'Durable and strong transparent tape.',
                'price' => 18000,
                'image' => url('pictures/krayon-titi-12.jpg',)
            ],
        ]);
    }
}
